...
var someModule_1 = __webpack_require__(49);
var selector = __webpack_require__(9);
var HDC = (function () {
    function HDC(divContainer, chartType, properties) {
        if (divContainer) {
            var setParentSelector = selector.select(divContainer);
            this._constructionPattern.setParentSelector(setParentSelector);
        }
    }
    return HDC;
}());
var goga = new someModule_1.default('goga', 22);
